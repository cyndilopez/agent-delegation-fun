"""Shared git operations for agents that commit and push."""
...
from bot_shared.models import FileEdit
...
def apply_edits_and_push(
    ...
    with tempfile.TemporaryDirectory() as tmp:
        workdir = Path(tmp)
        _run(["git", "clone", "--depth", "1", "--branch", branch, _repo_url(owner, repo), str(workdir)])
